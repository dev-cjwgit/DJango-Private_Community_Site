...
def post_new(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # return redirect('articles:post_detail', article.pk)
    ...
    return render(request, 'articles/post_new.html', context)
...
def post_edit(request, pk):
    ...
    return render(request, 'articles/post_edit.html', context)
...
def comments_new(request, article_pk):  # POST
    ...
    return redirect('articles:post_detail', article_pk)
